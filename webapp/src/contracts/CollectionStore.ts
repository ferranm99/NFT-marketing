...
export interface SetFeeOwnerEventLog
  extends EventLog<SetFeeOwnerEvent, 'SetFeeOwner'> {}
interface CollectionStoreEvents {
  Bought: EventSubscriptionFactory<BoughtEventLog>
  MetaTransactionExecuted: EventSubscriptionFactory<
    MetaTransactionExecutedEventLog
  >
...
export interface CollectionStoreTransactionReceipt
  extends TransactionReceipt<CollectionStoreTxEventLogs> {}
